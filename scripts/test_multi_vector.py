...
class MultiVectorTester:
            ...
            for query in queries:
                ...
                comparison = {
                    ...
                    "cosine": {
                        ...
                        "top_scores": [
                            doc.get("score", 0) 
                            for doc in cosine_result.get("source_docs", [])[:3]
                        ],
    ...
    async def _make_chat_request(self, session: aiohttp.ClientSession, 
                                query: str, similarity_metric: str) -> Dict[str, Any]:
    ...
    def _calculate_score_difference(self, cosine_docs: List[Dict], 
                                  dot_product_docs: List[Dict]) -> Dict[str, float]:
    ...
    def _generate_summary(self, comparisons: List[Dict]) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_timing": {
                ...
                "dot_product_ms": sum(dot_product_times) / len(dot_product_times) if dot_product_times else 0
            },
            "score_analysis": {
                "avg_score_differences": [
                    c["score_difference"]["avg_difference"] 
                    for c in comparisons
                ],
                "max_score_differences": [
                    c["score_difference"]["max_difference"] 
                    for c in comparisons
                ]
            }
        }
