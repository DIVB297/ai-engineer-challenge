...
def prepare_toy_qa_data():
    ...
    toy_qa_data = [
        ...
        {"question": "What is NLP?", "answer": "Natural Language Processing is a branch of AI that helps computers understand human language."},
        {"question": "What is a GPU?", "answer": "A Graphics Processing Unit is specialized hardware for parallel processing tasks."},
        {"question": "What is cloud computing?", "answer": "Cloud computing delivers computing services over the internet on-demand."},
        {"question": "What is data science?", "answer": "Data science combines statistics, programming, and domain expertise to extract insights from data."}
    ]
